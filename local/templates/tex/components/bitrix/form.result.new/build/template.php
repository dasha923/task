        ...
        <div class="contact-form__form-inputs">
            <div class="input contact-form__input">
                <label class="input__label" for="form_name_<?=$arResult['QUESTIONS']['NAME']['ID']?>">
                    ...
                    <input class="input__input" type="text" id="form_name_<?=$arResult['QUESTIONS']['NAME']['ID']?>" name="form_text_<?=$arResult['QUESTIONS']['NAME']['ID']?>" value="<?=htmlspecialchars($arResult['arrVALUES']['form_text_' . $arResult['QUESTIONS']['NAME']['ID']])?>" required minlength="3">
            ...
            <div class="input contact-form__input">
                <label class="input__label" for="form_company_<?=$arResult['QUESTIONS']['COMPANY']['ID']?>">
                    ...
                    <input class="input__input" type="text" id="form_company_<?=$arResult['QUESTIONS']['COMPANY']['ID']?>" name="form_text_<?=$arResult['QUESTIONS']['COMPANY']['ID']?>" value="<?=htmlspecialchars($arResult['arrVALUES']['form_text_' . $arResult['QUESTIONS']['COMPANY']['ID']])?>" required minlength="3">
                    <div class="input__notification">Поле должно содержать не менее 3-х символов</div>
                </label>
            </div>
            <div class="input contact-form__input">
                <label class="input__label" for="form_email_<?=$arResult['QUESTIONS']['EMAIL']['ID']?>">
                    ...
                    <input class="input__input" type="email" id="form_email_<?=$arResult['QUESTIONS']['EMAIL']['ID']?>" name="form_text_<?=$arResult['QUESTIONS']['EMAIL']['ID']?>" value="<?=htmlspecialchars($arResult['arrVALUES']['form_text_' . $arResult['QUESTIONS']['EMAIL']['ID']])?>" required>
            ...
            <div class="input contact-form__input">
                <label class="input__label" for="form_phone_<?=$arResult['QUESTIONS']['PHONE']['ID']?>">
                    ...
                    <input class="input__input" type="tel" id="form_phone_<?=$arResult['QUESTIONS']['PHONE']['ID']?>" name="form_text_<?=$arResult['QUESTIONS']['PHONE']['ID']?>" value="<?=htmlspecialchars($arResult['arrVALUES']['form_text_' . $arResult['QUESTIONS']['PHONE']['ID']])?>" required>
                </label>
            </div>
        </div>
        <div class="contact-form__form-message">
            <div class="input">
                <label class="input__label" for="form_message_<?=$arResult['QUESTIONS']['MESSAGE']['ID']?>">
                    ...
                    <textarea class="input__input" id="form_message_<?=$arResult['QUESTIONS']['MESSAGE']['ID']?>" name="form_textarea_<?=$arResult['QUESTIONS']['MESSAGE']['ID']?>" rows="5"><?=htmlspecialchars($arResult['arrVALUES']['form_textarea_' . $arResult['QUESTIONS']['MESSAGE']['ID']])?></textarea>
